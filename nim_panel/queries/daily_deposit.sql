...
-- 2025-09'dan itibaren (eski: 31/12/2025): Sector Comparison gün-gün outstanding
-- serisi 2025-10'dan başlar ve 1-3 gün (O/N/Kasa) STOK bileşenini bu kaynaktan
-- alır → stok geçmişi seri başlangıcını kapsamalı, yoksa 2025 sonu bakiyesi
-- yapay biçimde düşük görünür.
WHERE DAT >= TO_DATE('01/09/2025', 'dd/mm/yyyy')
  AND CUR = 'TRY'
  AND TYPE2 <> 'vadesiz'
  AND TYPE <> 'demand'
