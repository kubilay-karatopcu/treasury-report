...
# ── app.py 4199-4279 ──
@nim_panel_bp.route("/api/deposit_detail_dates", methods=["GET"])
@login_required
...
@nim_panel_bp.route("/api/deposit_detail_waterfalls", methods=["GET"])
@login_required
...
@nim_panel_bp.route("/api/daily_deposit_dates", methods=["GET"])
@login_required
...
@nim_panel_bp.route("/api/daily_deposit_waterfalls", methods=["GET"])
@login_required
...
# ── app.py 5078-5139 ──
@nim_panel_bp.route("/api/rate_drill", methods=["GET"])
@login_required
def api_rate_drill():
...
# ── app.py 5140-5205 ──
@nim_panel_bp.route("/api/cost_rate_heatmap", methods=["GET"])
@login_required
...
# ── app.py 5206-5399 ──
@nim_panel_bp.route("/api/hm_product_bar", methods=["GET"])
@login_required
...
# ── app.py 5400-5504 ──
@nim_panel_bp.route("/api/deposit_product_daily", methods=["GET"])
@login_required
...
# ── app.py 5505-5583 ──
@nim_panel_bp.route("/api/bubble_series", methods=["GET"])
@login_required
