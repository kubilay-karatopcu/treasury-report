...
(bkz. nim_panel/tools/extract_a6.py).
"""
...
# ── app.py 4488-4620 ──
@nim_panel_bp.route("/api/sector_deposit_rates", methods=["GET"])
@login_required
...
# ── app.py 4621-4647 ──
@nim_panel_bp.route("/api/tcmb_rate_table", methods=["GET"])
@login_required
...
# ── app.py 4648-4678 ──
@nim_panel_bp.route("/api/sector_blotter", methods=["GET"])
@login_required
...
# ── app.py 4679-4727 ──
@nim_panel_bp.route("/api/sector_outstanding", methods=["GET"])
@login_required
...
# ── app.py 4728-4774 ──
@nim_panel_bp.route("/api/sector_outstanding_monthly", methods=["GET"])
@login_required
...
# ── app.py 4775-4805 ──
@nim_panel_bp.route("/api/sector_mix_attribution", methods=["GET"])
@login_required
...
# ── app.py 4806-4827 ──
@nim_panel_bp.route("/api/sector_vade_mix", methods=["GET"])
@login_required
...
# ── app.py 4828-4848 ──
@nim_panel_bp.route("/api/sector_vade_mix_pres", methods=["GET"])
@login_required
...
# ── app.py 6751-6886 ──
@nim_panel_bp.route("/api/bsc_np_rate_series", methods=["GET"])
@login_required
...
# ── app.py 6887-6981 ──
@nim_panel_bp.route("/api/bsc_np_monthly_table", methods=["GET"])
@login_required
