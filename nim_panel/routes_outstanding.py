...
# ── app.py 4298-4367 ──
@nim_panel_bp.route("/api/tenor_dates", methods=["GET"])
@login_required
def api_tenor_dates():
...
@nim_panel_bp.route("/api/tenor_monthly", methods=["GET"])
@login_required
...
@nim_panel_bp.route("/api/tenor_daily", methods=["GET"])
@login_required
def api_tenor_daily():
    date_0 = request.args.get("date_0", "").strip()
    date_1 = request.args.get("date_1", "").strip()
...
# ── app.py 4454-4487 ──
@nim_panel_bp.route("/api/balance_dates", methods=["GET"])
@login_required
...
# ── app.py 4849-4895 ──
@nim_panel_bp.route("/api/balance_monthly", methods=["GET"])
@login_required
...
@nim_panel_bp.route("/api/balance_daily", methods=["GET"])
@login_required
...
# ── app.py 5015-5077 ──
@nim_panel_bp.route("/api/balance_drill", methods=["GET"])
@login_required
