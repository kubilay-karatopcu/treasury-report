...
// Re-exported so existing imports from this file (e.g. FixedDateFilter) work.
import { _resolveDateExpr } from '../../shared/dateExpr.js';
export { _resolveDateExpr };
...
// _pad2 / _toIsoDate / _resolveDateExpr moved to ../../shared/dateExpr.js
