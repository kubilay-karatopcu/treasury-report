...
DDL = {
    "FI_DEALS": """CREATE TABLE {t} (
        DEAL_ID VARCHAR2(24), BORROWER_BANK VARCHAR2(256),
    ...
    "FI_OFFER_EVENTS": """CREATE TABLE {t} (
        ...
        LENDER_BANK VARCHAR2(256), LENDER_COUNTRY VARCHAR2(128),
        LENDER_REGION VARCHAR2(128), GROUP_COMPANY VARCHAR2(256),
        GROUP_COMPANY_COUNTRY VARCHAR2(128), GROUP_COMPANY_REGION VARCHAR2(128),
    ...
    "FI_LU_BANK": """CREATE TABLE {t} (
        BANK_NM VARCHAR2(256), COUNTRY VARCHAR2(128), REGION VARCHAR2(128),
        GROUP_COMPANY VARCHAR2(256), GROUP_COMPANY_COUNTRY VARCHAR2(128),
        GROUP_COMPANY_REGION VARCHAR2(128),
        IS_SELF NUMBER(1), ACTIVE_FLG NUMBER(1), LOADED_AT DATE)""",
    "FI_LU_LIST": """CREATE TABLE {t} (
        LIST_NAME VARCHAR2(32), VALUE_CD VARCHAR2(256), LABEL VARCHAR2(256),
        PARENT_CD VARCHAR2(256), ATTR1 VARCHAR2(128), SORT_NO NUMBER,
