"""mevduat_panel Outstanding portu — hızlı doğrulama testleri.
...
Koşum: repo kökünden `python -m pytest mevduat_panel/tests -q`
"""
...
from mevduat_panel.engine.common import (  # noqa: E402
...
def test_data_source_bilinmeyen_sorgu():
    from mevduat_panel.data_source import _sql
