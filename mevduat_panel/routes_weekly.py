...
# ── app.py 4896-5014 ──
@mevduat_panel_bp.route("/api/weekly_rollings", methods=["GET"])
@login_required
...
@mevduat_panel_bp.route("/api/weekly_segments", methods=["GET"])
@login_required
...
@mevduat_panel_bp.route("/api/weekly_drilldown", methods=["GET"])
@login_required
