...
bloklamamak için daemon thread'de koşar ve `MEVDUAT_PANEL_PREWARM=1` ortam
...
def start_background_prewarm(app) -> None:
    ...
    t = threading.Thread(target=_prewarm, args=(app,), name="mevduat-panel-prewarm", daemon=True)
    t.start()
